        ...
        <div className='mt-8'>
            ...
            <div >
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 mt-8'>
                    { showAll ? 
                        chefdata.map(chef => <ChefCategoryDetails key={chef.chef_id} chef={chef}></ChefCategoryDetails>)
                        : chefdata
                        .slice(0, 4)
                        .map(chef => <ChefCategoryDetails key={chef.chef_id} chef={chef}></ChefCategoryDetails>)
                    }
                </div>
